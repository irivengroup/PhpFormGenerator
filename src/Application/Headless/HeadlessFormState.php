...
{
    /** @param array<string, mixed> $payload @param array<string, mixed> $errors @param array<string, mixed> $metadata */
    ...
    public function submitted(): bool { return $this->submitted; }
