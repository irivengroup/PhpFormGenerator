...
### FormTypeInterface contract

All application form types now explicitly implement both required methods:
- `buildForm(...)`
- `configureOptions(...)`

Default form type behavior sets:
- `csrf_protection => true`

This keeps custom form types compliant with the framework contract while preserving secure defaults.
